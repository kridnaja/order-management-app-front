...
export default function ReNewOrderPrintPage({ targetOrderIdToEdit }) {
  const { salesCreateOrder, salesEditOrder, errorSalesCreateExistedOrder } =
    useAuth();
  ...
  return (
    <div className="absolute  z-30 w-full flex justify-center items-start top-0 bg-white">
                    ...
                    <div className="flex flex-row items-center mr-[0.25rem]">
                      ...
                      {/* <div className="flex flex-row items-center mr-[0.25rem]">
                        <input
                          ...
                          name="typeOfColor"
                          value={"BLACK"}
                          checked={input.typeOfColor == "BLACK"}
                          type="radio"
                          id=""
                          className="mx-[0.25rem] h-[1rem] w-[1rem]"
                        />
